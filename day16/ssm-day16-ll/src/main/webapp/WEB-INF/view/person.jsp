...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">取款银行</span>
			 ...
			 <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">取款日期 </span>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--pId pName pSex pLike pCount pAge createtime bId  -->
							...
							<tr><!--   pAge createtime bId  -->
							<!--  ，，人员年龄，存款日期，存款银行-->
								<td>人员爱好：</td>
								<td>
									<input type="checkbox" id="pLike" name="pLike" value="篮球">篮球
									<input type="checkbox" id="pLike" name="pLike" value="足球">足球
									<input type="checkbox" id="pLike" name="pLike" value="排球">排球
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>存款金额：</td>
	...
	<!-- 新增和-->
	<div class="modal fade" id="addBank" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form" method="post" action="addBank.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--pId pName pSex pLike pCount pAge createtime bId  -->
							<!--  人员编号，人员姓名，人员性别，人员爱好，存款金额，人员年龄，存款日期，存款银行-->
								<td>人员姓名：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_addBank_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="pId"> 刪除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
	...
	$(function () {
	    ...
	    $("#submit_form_addBank_btn").click(function(){
	    	$("#form").submit();
	    });
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addBank").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_userid").value='';
	    		$('#addBank').modal({backdrop: 'static', keyboard: false});
				$('#addBank').modal('show');
	        });
	    	$("#btn_echarts").click(function(){
				...
				var tb = echarts.init(document.getElementById("Tu"))
				var list = new Array()
				$.ajax({
				    url:"echarts.htm",
				    type:"post",
				    success:function(res){
				    	...
				    	for (var i = 0; i < obj.length; i++) {
							list[i] = {value:obj[i].num,name:obj[i].bName}
						}
				    	option = {
								tooltip : {
									trigger : 'item',
