					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							员工编号,员工名称,员工性别,所属公司,入职时间 -->
								...
								<td>&nbsp;&nbsp;</td>
								<td>员工性别：</td>
								<td><input type="radio" id="gender" name="gender" value="男">男</td>
								<td><input type="radio" id="gender" name="gender" value="女">女</td>
							</tr>
							<tr>
								<td>所属公司：</td>
								<td colspan="4">
	    		...
	    		$.ajax({
	    		    ...
	    		    success:function(res){
	    		    	...
	    		    	for (var i = 0; i < obj.length; i++) {
							s[i] ={value:obj[i].num,name:obj[i].cname}
						}
	    		    	option = {	
	    		    			series: [
	    		    			    {
