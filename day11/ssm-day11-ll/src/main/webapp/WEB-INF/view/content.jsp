...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveContent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--contentid 编号,contenttitle 广告标题,contentcategoryid 
				            	广告分类，picpath 图片路径，contenturl 广告链接，price 费用，
				            	status 广告状态  -->
								<td>广告标题：</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="contentid"> 刪除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
	...
	<div class="modal fade" id="echarts" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="width: 400px;height: 400px" id="zhu" >
				</div>
				<div class="modal-header" style="width: 400px;height: 400px" id="xian" >
				</div>
				<div class="modal-header" style="width: 400px;height: 400px" id="bing" >
				</div>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
				...
				var ta = echarts.init(document.getElementById("zhu"))
				var tb = echarts.init(document.getElementById("xian"))
				var tc = echarts.init(document.getElementById("bing"))
				...
				$.ajax({
				    ...
				    success:function(res){
				    	...
				    	for (var i = 0; i < obj.length; i++) {
				    		nums[i] = obj[i].num
				    		categorynames[i] = obj[i].categoryname
				    		list[i] = {value:nums[i],name:categorynames[i]}
						}
				    	option = {
	    					    xAxis: {
	    					        type: 'category',
