...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">入职时间区间检</span>
			      <input type="date" name="kdate" class="form-control" id="kdate" >
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--编号，人员姓名，人员性别，人员特点，入职时间，所属公司，创建时间  -->
								<td>人员姓名：</td>
							...
							<tr><!--，，，  -->
								<td>人员特点：</td>
								<td><input type="checkbox" id="expressTrait" name="expressTrait" value="勤奋">勤奋
									<input type="checkbox" id="expressTrait" name="expressTrait" value="可爱">可爱
									<input type="checkbox" id="expressTrait" name="expressTrait" value="长得高">长得高
									<input type="checkbox" id="expressTrait" name="expressTrait" value="帅">帅
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait').val();
		var t = getSelection.expressTrait
		var str = t.split(",")
