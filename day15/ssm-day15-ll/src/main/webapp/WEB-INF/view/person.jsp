...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--人员编号,人员姓名,人员性别,人员爱好,存款金额,人员年龄,存款日期,存款银行  -->
							<!-- pId,pName,pSex,pLike，pCount，pAge，createtime，bId -->
								<td>人员姓名：</td>
							...
							<tr>
								<td>人员爱好：</td>
								<td><input type="checkbox" id="pLike" name="pLike" value="篮球">篮球
	...
	<!-- 新增Bank -->
	<div class="modal fade" id="Bank" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form" method="post" action="Bank.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>银行名称：</td>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addBank").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_userid").value='';
	    		$('#Bank').modal({backdrop: 'static', keyboard: false});
				$('#Bank').modal('show');
	        });
				...
				$.ajax({
				    ...
				    success:function(res){
				    	...
				    	for (var i = 0; i < obj.length; i++) {
				    		...
				    		list[i] = {value:nums[i],name:bNames[i]}
						}
				    	option = {
								tooltip : {
									trigger : 'item',
