...
<body class="gray-bg">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="kdate"id="txt_search_username" >
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--sdId, sdname, sdsex, sdhobby, sdbirth, mid -->
							...
							<tr>
								<td>学生爱好：</td>
								<td>
									<input type="checkbox" id="sdhobby" name="sdhobby" value="篮球">篮球
									<input type="checkbox" id="sdhobby" name="sdhobby" value="足球">足球
									<input type="checkbox" id="sdhobby" name="sdhobby" value="排球">排球
									<input type="checkbox" id="sdhobby" name="sdhobby" value="乒乓球">乒乓球
	...
	<!-- 新增专业对话框 -->
	<div class="modal fade" id="addMajor" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form" method="post" action="addMajor.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>专业名称：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_addMajor_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="sdId"> 刪除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
	...
	<!--echarts对话框 -->
	<div class="modal fade" id="echarts" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="width: 300px;height: 300px" id="Tu" >
				</div>
				<div class="modal-header" style="width: 300px;height: 300px" id="Tu1" >
				</div>
				<div class="modal-header" style="width: 300px;height: 300px" id="Tu2" >
				</div>
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_echarts").click(function(){
	    		$('#echarts').modal({backdrop: 'static', keyboard: false});
				$('#echarts').modal('show');
				var ta = echarts.init(document.getElementById("Tu"))
				var tb = echarts.init(document.getElementById("Tu1"))
				var tc = echarts.init(document.getElementById("Tu2"))
				var nums = new Array()
				var mdnames = new Array()
				var list = new Array()
				$.ajax({
				    url:"echarts.htm",
				    type:"post",
				    success:function(res){
				    	...
				    	for (var i = 0; i < obj.length; i++) {
				    		nums[i] = obj[i].num
				    		mdnames[i] = obj[i].mdname
				    		list[i] = {value:nums[i],name:mdnames[i]}
						}
				    	option = {
	    					    xAxis: {
	    					        type: 'category',
	...
	function initEditUser(getSelection){
		...
		for (var i = 0; i < str.length; i++) {
			$('input[value='+str[i]+']').prop("checked",true);
		}
