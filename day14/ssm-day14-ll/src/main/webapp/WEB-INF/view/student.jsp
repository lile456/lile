...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">选择学生年级</span>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--id, teacherid, name, age, code, grade, entrytime
								,,老师姓名,年龄,所属年级,入校时间,创建时间
								<!--id, teacherid, name, age, , grade, entrytime
							  -->
								<td>学生编号：</td>
	...
	<!-- 新增和修改对话框 -->
	<div class="modal fade" id="addTeacher" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form" method="post" action="addTeacher.htm">
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addTeacher").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_userid").value='';
	    		$('#addTeacher').modal({backdrop: 'static', keyboard: false});
					...
					$.ajax({
					    ...
					    success:function(res){
					    	...
					    	for (var i = 0; i < obj.length; i++) {
								list[i] = {value:obj[i].num,name:obj[i].tname}
							}
					    	option = {
									tooltip : {
										trigger : 'item',
