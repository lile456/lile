...
<body class="gray-bg">
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm" enctype="multipart/form-data">
						...
						<input type="hidden" name="photo" id="img1" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<td><input type="file" id="img" name="img">
									<img id="img2" width="30" height="30" >
								</td>
								<td>&nbsp;&nbsp;</td>
								<td>入学日期：</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="sid"> 刪除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
				...
				$.ajax({
				    ...
				    success:function(res){
				    	...
				    	for (var i = 0; i < obj.length; i++) {
				    		bin[i] = {value:obj[i].num,name:obj[i].tname}
						}
				    	option = {
								tooltip : {
									trigger : 'item',
	...
	function initEditUser(getSelection){
		...
		$('#img1').val(getSelection.photo);
		$('#img2').prop("src","/photo/"+getSelection.photo)
		$('#date').val(new Date(getSelection.date).Format("yyyy-MM-dd"));
