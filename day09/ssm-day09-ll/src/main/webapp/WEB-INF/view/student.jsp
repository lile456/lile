...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div >
			      <span class="input-group-addon">入职时间查询 </span>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--id,code,name,age,courseid,grade, entrytime,createtime  -->
							...
							<tr><!--id,code,name,age,courseid,, ,createtime  -->
								<!-- 学生编号,姓名,年龄,所选课程,, -->
								<td>所属年级：</td>
	...
	<!-- 新增课程 -->
	<div class="modal fade" id="addc" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_addc" method="post" action="addCourse.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>课程名称：</td>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_addc_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    // 添加部门
	    var validator = $("#form_addc").validate({
    		submitHandler: function(form){
   		      $(form).ajaxSubmit({
   		    	dataType:"json",
   		    	success: function (data) {
	    ...
	    $("#submit_form_addc_btn").click(function(){
	    	$("#form_addc").submit();
	    });
	});
	...
	var ButtonInit = function () {
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_addc").click(function(){
	    		...
	    		$("#form_user").resetForm();
	    		document.getElementById("hidden_txt_userid").value='';
	    		$('#addc').modal({backdrop: 'static', keyboard: false});
				$('#addc').modal('show');
	        });
	        // 饼状图
					...
					$.ajax({
					    ...
					    success:function(res){
					    	...
					    	for (var i = 0; i < obj.length; i++) {
					    		list[i] = {value:obj[i].num,name:obj[i].cname}
							}
					    	option = {
									tooltip : {
										trigger : 'item',
