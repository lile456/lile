				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--学生编号，学生姓名，学生生日，学生年龄，学生性别，学校名称  -->
								<!--sid, name, date, age, sex, id  -->
								<td>学生姓名：</td>
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form" method="post" action="dr.htm" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_student_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
