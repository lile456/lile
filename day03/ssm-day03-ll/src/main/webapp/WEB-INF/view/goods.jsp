...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  <div class="col-lg-2">
				<div >
			      <span >创建日期 </span>
			      <input type="date" name="kdate" class="form-control" id="txt_search_username" >
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="gId"> 刪除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
	...
	<div class="modal fade" id="zhu" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="width:400px;height:400px"  id="Tj">
				</div>
				<div class="modal-footer">
	    ...
	    oInit.Init = function () {
	    	...
	    	$("#btn_zhu").click(function(){
	    		$('#zhu').modal({backdrop: 'static', keyboard: false});
	    			var tb = echarts.init(document.getElementById("Tj"))
	    			var nums = new Array();
