...
public class Content implements Serializable {
    ...
    public Content(Integer contentid, Integer contentcategoryid, String contenttitle, String contenturl, String picpath,
			Double price, String status, Date createtime) {
		super();
