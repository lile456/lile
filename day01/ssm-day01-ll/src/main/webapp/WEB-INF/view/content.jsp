...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveContent.htm" enctype="multipart/form-data">
						<input type="hidden" name="contentid" id="hidden_txt_userid" value=""/>
						<input type="hidden" name="picpath" id="img" value=""/>
						<table style="border-collapse:separate; border-spacing:0px 10px;">
						<!--广告标题,广告分类,图片,广告连接,费用,广告状态,创建日期  -->
							<tr> 
								<td>广告标题：</td>
							...
							<tr>
								...
								<td><img id="photo1" width="30" height="30"  > </td>
							...
							<tr>
								<td>费用：</td>
								<td><input type="double" id="price" name="price"
									class="form-control" aria-required="true" required/></td>
			...
			<div class="modal-content">
				<div class="modal-body">
					...
					<form id="form" method="post" action="dr.htm" enctype="multipart/form-data">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="submit_form_cont_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	$(function () {
	    ...
	    $("#submit_form_cont_btn").click(function(){
	    	$("#form").submit();
	    });
	});
	        ...
	        $('#table_user').bootstrapTable({
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                sortable:true,
	                formatter:function(value,row,index){
	                	return '<img src="/photo/'+value+'" width="30" height="30" >';
	                }
	            }, {
	                field: 'contenturl',
	                title: '广告连接',
