...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div>
			      <span class="input-group-addon">入职时间区间查 </span>
			      <input type="date" name="kdate" id="kdate" >
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!-- id, expressName, sex, expressTrait, entryTime, createTime, expressTypeId -->
							...
							<!--,,,,创建时间  -->
								<td>人员特点：</td>
								<td>
									<input type="checkbox" id="expressTrait" name="expressTrait" value="耐劳">耐劳
									<input type="checkbox" id="expressTrait" name="expressTrait" value="勤奋">勤奋
									<input type="checkbox" id="expressTrait" name="expressTrait" value="坚强">坚强
									<input type="checkbox" id="expressTrait" name="expressTrait" value="聪明">聪明
								</td>
	...
	<div class="modal fade" id="dr" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form" method="post" action="dr.htm" enctype="multipart/form-data">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>导入：</td>
								<td><input type="file" name="xls"
									class="form-control" aria-required="true" required/></td>
							</tr>
						</table>
						<div class="modal-footer">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="id"> 刪除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
	...
	<div class="modal fade" id="echarts" role="dialog" aria-labelledby="modal_user_del" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header" style="width: 400px;height: 400px" id="Tu">
				</div>
				<div class="modal-header" style="width: 400px;height: 400px" id="Tu1">
				</div>
				<div class="modal-header" style="width: 400px;height: 400px" id="Tu2">
				</div>
				...
				$.ajax({
				    ...
				    success:function(res){
				    	...
				    	for (var i = 0; i < obj.length; i++) {
				    		...
				    		list[i] = {value:nums[i],name:cnames[i]}
						}
				    	option = {
	    					    xAxis: {
	    					        type: 'category',
	...
	function initEditUser(getSelection){
		...
		var th = getSelection.expressTrait
		var str = th.split(",");
