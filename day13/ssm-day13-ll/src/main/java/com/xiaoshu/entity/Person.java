...
public class Person implements Serializable {
    ...
    public Person(Integer id, String expressName, String sex, String expressTrait, Date entryTime, Date createTime,
			Integer expressTypeId) {
		super();
		this.id = id;
		this.expressName = expressName;
		this.sex = sex;
		this.expressTrait = expressTrait;
