...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveGoods.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!-- code 编号, name 商品名称,typeid
							 所属分类,price 价格,status 状态, -->
								<td>编号：</td>
	...
	<!-- 部门添加 -->
	<div class="modal fade" id="Type" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form" method="post" action="addType.htm">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								<td>分类名称：</td>
								...
								<td><select class="form-control" name="status" id = "status" aria-required="true" required>
										<option value="">---请选择---</option>
										<option value="上架">启用</option>
										<option value="下架">禁用</option>
				                	</select>
				                </td>
							</tr>
						</table>
