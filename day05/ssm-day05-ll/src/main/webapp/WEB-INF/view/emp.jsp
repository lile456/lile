...
<body class="gray-bg">
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveEmp.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr><!--eId, eName, birthday, gender, age, pic, dDepid, hobby  -->
							<!-- 编号 姓名 日期 性别 年龄 图片 部门 爱好 -->
								<td>姓名：</td>
							...
							<tr><!--gender, age, pic, dDepid, hobby  -->
							<!-- 性别 年龄 图片 部门 爱好 -->
								<td>性别：</td>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					 ...
					 <h4 class="modal-title" id="eId"> 刪除  </h4>
				</div>
				<div class="modal-body">
							删除所选记录？
				</div>
	...
	function initEditUser(getSelection){
		...
		$('#pic1').val(getSelection.pic);
		
		$('#pic').prop("src","/photo/"+getSelection.pic);
